...
public class PedometerSettings {
	...
	public float getStepLength() {
		try {
			return Float.valueOf(mSettings.getString("step_length", "30")
					.trim());
	...
	public void setStepLength(String stepLength) {
		mSettings.edit().putString("step_length", stepLength).commit();
	}

	public int getBodyHeight() {
		return mSettings.getInt("body_height", 170);
	}

	public void setSex(int sex) {
		mSettings.edit().putInt("sex", sex).commit();
	}

	public int getSex() {
		return mSettings.getInt("sex", 0);
	}

	public void setBirth(int birth) {
		mSettings.edit().putInt("birth", birth).commit();
	}

	public int getBirth() {
		return mSettings.getInt("birth", 1980);
	}

	public void setActivity(int activity) {
		mSettings.edit().putInt("activity", activity).commit();
	}

	public int getActivity() {
		return mSettings.getInt("activity", 2);
	}

	public void setBodyHeight(int bodyHeight) {
		mSettings.edit().putInt("body_height", bodyHeight).commit();
	}
	...
	public void setBodyWeight(String weight) {
		mSettings.edit().putString("body_weight", weight).commit();
	}
	...
	public boolean isNewStart() {
		...
		// Utils.currentTimeInMillis() - 1000*60*10;
		return true;
	}
